...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'New Category', href: '/dashboard/categories/create' },
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-8 p-6 md:p-8 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-serif font-semibold text-burgundy tracking-tight">Define Collection</h1>
                        <p className="text-sm text-muted-foreground mt-1 italic font-light">Craft a new aesthetic category for your masterpieces.</p>
                    </div>
                </div>
